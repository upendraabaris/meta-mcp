...
export async function main() {
    try {
        ...
        server.tool("get_ai_guidance", "Get comprehensive guidance for AI assistants on how to effectively use this Meta Marketing API server. Includes common workflows, tool combinations, troubleshooting tips, and best practices for campaign management and analytics.", {}, async () => {
            const guidance = {
                server_purpose: {
                ...
                common_workflows: {
                    ...
                    creative_optimization: {
                        description: "Test and optimize ad creatives for better performance",
                        step_by_step: [
                    ...
                    troubleshooting_and_diagnostics: {
                        description: "Diagnose and fix common Meta Ads API issues with enhanced error handling",
                        step_by_step: [
                ...
                tool_categories: {
                    ...
                    diagnostic_and_troubleshooting: {
                        ...
                        description: "Error diagnosis, troubleshooting, and validation tools",
                    },
                },
                best_practices: {
                    error_handling: [
                ...
                rate_limiting_guidance: {
                    description: "Meta API has strict rate limits that vary by access level",
                    best_practices: [
